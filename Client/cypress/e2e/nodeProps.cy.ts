...
describe('click a node', () => {
  it('should show the node details', () => {
    ...
    initWithAllNodes()
    cy.get(
      '#reactflow-wrapper > div > div.react-flow__renderer > div > div > div.react-flow__nodes > div.react-flow__node.react-flow__node-policies.nopan.selectable > div > div:nth-child(1) > img'
    ).realClick()
