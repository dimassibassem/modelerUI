...
describe('Valid steps in Sidebar', () => {
  ...
  it('Should render valid steps in sidebar', () => {
    ...
    cy.get(
      ...
      'div.react-flow__renderer > div > div > div.react-flow__nodes > div.react-flow__node.react-flow__node-end.nopan.selectable > div > div.react-flow__handle.react-flow__handle-top.nodrag.nopan.source.connectable.connectablestart.connectableend.connectionindicator'
    )
    ...
    cy.get('aside > div:nth-child(6)').should('be.visible')
    ...
    // assert that the edge is visible
    cy.get(
      'div.react-flow__renderer > div > div > svg > g > g:nth-child(3) > path.react-flow__edge-interaction'
    )
    ...
    cy.get(
      ...
      'div.react-flow__renderer > div > div > div.react-flow__nodes > div.react-flow__node.react-flow__node-policies.nopan.selectable > div > div.react-flow__handle.react-flow__handle-bottom.nodrag.nopan.source.connectable.connectablestart.connectableend.connectionindicator'
    )

    // assert that edge is visible
    cy.get(
      'div.react-flow__renderer > div > div > svg > g > g:nth-child(4) > path.react-flow__edge-interaction'
    )

    cy.get(
      'div.react-flow__renderer > div > div > div.react-flow__nodes > div.react-flow__node.react-flow__node-policies.nopan.selectable > div > div.react-flow__handle.react-flow__handle-left.nodrag.nopan.source.connectable.connectablestart.connectableend.connectionindicator'
    ).drag(
    ...
    // assert that edge is visible
    cy.get(
      'div.react-flow__renderer > div > div > svg > g > g:nth-child(5) > path.react-flow__edge-interaction'
    )
    ...
    cy.get('#right-sidebar > div:nth-child(6) > div > ul > li ').should(
      'be.visible'
    )
