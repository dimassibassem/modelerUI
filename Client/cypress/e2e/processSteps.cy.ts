...
describe('Valid steps in Sidebar', () => {
  ...
  it('Should render valid steps in sidebar', () => {
    ...
    // assert that the edge is visible
    cy.get('#root > div > div.grow.h-full > div > div.react-flow__renderer > div > div > svg > g > g:nth-child(3) > path.react-flow__edge-interaction')
    ...
    cy
      ...
      .drag('#root > div > div.grow.h-full > div > div.react-flow__renderer > div > div > div.react-flow__nodes > div.react-flow__node.react-flow__node-policies.nopan.selectable > div > div.react-flow__handle.react-flow__handle-bottom.nodrag.nopan.source.connectable.connectablestart.connectableend.connectionindicator')

    // assert that edge is visible
    cy.get('#root > div > div.grow.h-full > div > div.react-flow__renderer > div > div > svg > g > g:nth-child(4) > path.react-flow__edge-interaction')

    cy.get('#root > div > div.grow.h-full > div > div.react-flow__renderer > div > div > div.react-flow__nodes > div.react-flow__node.react-flow__node-policies.nopan.selectable > div > div.react-flow__handle.react-flow__handle-left.nodrag.nopan.source.connectable.connectablestart.connectableend.connectionindicator')
    ...
    // assert that edge is visible
    cy.get('#root > div > div.grow.h-full > div > div.react-flow__renderer > div > div > svg > g > g:nth-child(5) > path.react-flow__edge-interaction')

    // assert shown steps in sidebar with cycle
    // scroll to bottom of sidebar
    cy.get('#root > div > aside > div:nth-child(8)')
      .scrollIntoView()


    cy.get('#root > div > aside > div:nth-child(7)')
      .should('be.visible')
