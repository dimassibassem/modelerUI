...
const useAllCommands = () => {
  const { reactFlowInstance, chainRecovery, setChainRecovery } = useStore(selector, shallow);
  ...
  return useMemo(() => [
        ...
        },
        {
          ...
          text: "lorem ipsum dolor sit amet, consectetur adipiscing elit.",
          icon: <Icon className="w-5 h-5" icon="ph:arrows-out-line-horizontal-fill" />,
          action: async () => {
        ...
        },
        {
          ...
          text: "lorem ipsum dolor sit amet, consectetur adipiscing elit.",
          icon: <Icon className="w-5 h-5" icon="ph:arrows-out-line-vertical-fill" />,
          action: async () => {
        ...
        },
        {
          ...
          name: "Full screen",
          text: "lorem ipsum dolor sit amet, consectetur adipiscing elit.",
          icon: isFullScreen ? <Icon className="w-5 h-5" icon="solar:quit-full-screen-bold" /> :
