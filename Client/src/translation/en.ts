const en = {
  ...
  DraggableElements:
    'Here you can find all the stages you can drag to the flow',
  DropLocation: 'Here you can drop the stages you want to use in your process',
  ...
  processCreateNew: 'Create New Process',
  Delete: 'Delete',
  DeleteProcess: 'Delete Process',
  DeleteProcessConfirmation:
    'Are you sure you want to delete this process? All of the data will be permanently removed.',
  Recent: 'Recent',
  BankeriseProcessesList: 'List of all the Processes you have created.',
  BankeriseProcesses: 'Bankerise Processes',
  tryAgainContent:
