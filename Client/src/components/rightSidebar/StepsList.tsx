              ...
              {steps.map((step, stepArrayIndex) => (
                ...
                >
                  <button
                    type="button"
                    onClick={() =>
                      toggleExpand(stepsArrayIndex, stepArrayIndex)
                    }
                    className={classNames(
                      step.attributes
                        ? 'hover:bg-gray-50 hover:cursor-pointer absolute opacity-1 w-full h-full z-2 '
                        : '',
                      'block'
                    )}
                  />
                      ...
                      <div className="flex items-center px-4 py-4 sm:px-6">
                        <div className="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
                          <div className="flex text-sm">
                            <p className="font-medium z-10 text-indigo-600">
                              {step.type}
                            </p>
                          </div>
                        </div>
