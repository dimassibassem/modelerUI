...
const BottomLeftPanel = ({
  ...
  return (
    <Panel id='bottom-left' className="grid grid-cols-1 gap-2" position="bottom-left">
      <div className=" grid grid-cols-3 gap-2 justify-items-stretch">
        ...
        >
          <Icon className="w-5 h-5" icon="material-symbols:swap-vertical-circle-outline-rounded" />
        </button>
        <button
          className="rounded flex justify-center bg-indigo-50 py-1 px-2 text-sm font-semibold text-indigo-600 shadow-sm hover:bg-indigo-100"
          type="button"
        ...
        >
          <Icon className="w-5 h-5" icon="material-symbols:swap-horizontal-circle-outline-rounded" />
        </button>
        <button
          type="button"
          aria-label='Fit View'
      ...
      <div className="grid grid-cols-4 gap-2 justify-items-stretch">
        ...
        >
          {chainRecovery ? <Icon className="w-5 h-5" icon="fa:chain" /> :
        ...
        >
          {isFullScreen ? <Icon className="w-5 h-5" icon="solar:quit-full-screen-bold" /> :
